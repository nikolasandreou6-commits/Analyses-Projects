...
- **Currency conversion** to EUR using Power Query custom columns (GBP, SEK, NOK, PLN → EUR)
...
## Dataset
Two datasets were used (Jan–Jun and Jul–Dec 2024), imported and combined using Power Query. All monetary values were converted to EUR for consistency across markets.
...
### Task 6 — Dashboard
Interactive dashboard built in Excel with KPI summary cards, transaction status breakdown, decline reason analysis, provider performance table, monthly volume trends, and GEO analysis.

<img width="1550" height="810" alt="image" src="https://github.com/user-attachments/assets/100c68f7-bf29-466c-a8b9-011c741a5242" />
